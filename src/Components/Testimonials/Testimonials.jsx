                    ...
                    <div className="author border-t border-mediumgray flex items-center mt-10 pt-10">
                        {item.img && (
                            <img
                                width=""
                                height=""
                                className="rounded-circle w-[60px] h-[60px] mr-[19px]"
                                alt=""
                                src={item.img}
                            />
                        )}
                        <div className="inline-block align-middle">
                            {item.name && (
                                <span className="font-serif text-md font-medium leading-[20px] text-darkgray block uppercase">
                                    {item.name}
                                </span>
                            )}
            ...
            return (
                <div className={`${props.theme} `}>
                    ...
                    <div className="bg-white p-[49px] text-center relative">
                        ...
                        {item.name && (
                            <span className="font-serif font-medium text-center text-darkgray block">{item.name}</span>
                        )}
                        {item.designation && (
                            <span className="block font-serif text-sm font-medium">{item.designation}</span>
                        )}
                    </div>
                </div>
            );
            ...
            return (
                <div className={`${props.theme}`}>
                    ...
                    <div className="px-[20px] flex items-center">
                        ...
                        <div className="inline-block align-middle">
                            {item.name && (
                                <span className="font-serif text-md font-medium leading-[24px] text-darkgray block">
                                    {item.name}
                                </span>
                            )}
                    ...
                    <div className="items-center px-[20px] flex">
                        {item.img && (
                            <img
                                width=""
                                height=""
                                className="rounded-circle w-[60px] h-[60px] mr-[15px]"
                                src={item.img}
                                alt=""
                            />
                        )}
                        <div className="items-center">
                            {item.name && (
                                <span className="font-serif text-md leading-[16px] font-medium text-darkgray block">
                                    {item.name}
                                </span>
                            )}
                            {item.rating && (
                    ...
                    <div className="items-center flex flex-wrap">
                        {item && (
                            <img
                                width=""
                                height=""
                                className="rounded-circle w-[60px] h-[60px] mr-[20px]"
                                alt=""
                                src={item.img}
                            />
                        )}
                        <div>
                            ...
                            {item.name && (
                                <span className="font-serif text-md leading-5 font-medium text-gray-900 block">
                                    {item.name}
                                </span>
                            )}
                    ...
                    <div className="author border-t border-mediumgray flex items-center mt-10 pt-10">
                        {item.img && (
                            <img
                                width=""
                                height=""
                                className="rounded-circle w-[60px] h-[60px] mr-[16px]"
                                alt=""
                                src={item.img}
                            />
                        )}
                        <div>
                            {item.name && (
                                <span className="font-serif text-md font-medium text-darkgray block">{item.name}</span>
                            )}
    ...
    return props.carousel === true ? (
        ...
        >
            {props.data.map((item, i) => {
                return (
                    <SwiperSlide key={i} {...{ ...props.animation, transition: { delay: i * props.animationDelay } }}>
                        {' '}
                        {renderSwitch(props, item, i)}
                    </SwiperSlide>
                );
            })}
        </Swiper>
        ...
        <Row className={props.grid}>
            {props.data.map((item, i) => {
                return (
                    <m.div
                        className={`col flex justify-center${props.className ? ` ${props.className}` : ''}`}
                        key={i}
