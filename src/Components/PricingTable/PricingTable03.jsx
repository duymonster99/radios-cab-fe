...
const PriceTable03 = (props) => {
    return (
        <Row
            className={`pt-[7.5rem] sm:pt-[20px] pb-4 justify-center overflow-hidden ${
            ...
            {props.data.map((item, i) => {
                return (
                    <Col
                        ...
                        } text-center rounded-md p-[0px] sm:px-[10px]`}
                        style={item.popular && item.popular.color && { '--popular-bg': item.popular.color }}
                    >
                            ...
                            {item.buttonLink &&
                                (item.popular && item.popular.isPopular ? (
                                    <Buttons
                                        ...
                                        to={item.buttonLink}
                                        className="btn-fill font-medium font-serif uppercase mt-[5px]"
                                        color="#ffffff"
                                        size="md"
                                        themeColor="#232323"
                                    ...
                                    <Buttons
                                        ariaLabel="pricing table"
                                        to={item.buttonLink}
                                        className="font-medium font-serif uppercase bg-[#fff] hover:text-white"
                                        color="#000"
                                        size="md"
                                        themeColor="#000"
                                        title={item.buttonTitle}
