...
export default function DriverDetail(props) {
    ...
    const getOneDriver = async () => {
        try {
            fetch(`http://localhost:5082/api/v1/Admin/getDriverById/${state.id}`)
                    ...
                    <div className="xl:w-[80%] lg:w-[90%] md:w-[90%] sm:w-[92%] xs:w-[90%] mx-auto flex flex-col gap-4 items-center relative lg:-top-8 md:-top-6 sm:-top-4 xs:-top-4">
                        ...
                        <div className="w-full my-auto py-6 flex flex-col justify-center gap-2">
                            ...
                            <div className="flex flex-col pt-3 w-[30%]">
                                <Button type="primary" size='large' onClick={handleOpenForm}>Booking Driver</Button>
                                <FormBookingDriver isOpen={isOpen} setIsOpen={setIsOpen} />
                            </div>
                        </div>

                        <div className="fixed right-2 bottom-20 flex flex-col rounded-sm bg-gray-200 text-gray-500 hover:text-gray-600 ">
                            <Link href="https://www.linkedin.com/in/samuel-abera-6593a2209/">
                            ...
                            <Link href="https://twitter.com/Samuel7Abera7">
                                <div className="p-2 hover:text-primary">
                                    <svg
