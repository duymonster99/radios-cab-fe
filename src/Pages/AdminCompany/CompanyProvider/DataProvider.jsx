...
export const DataProvider = ({ children }) => {
    ...
    const navName = [
        ...
        { id: 3, title: 'Service Type', slug: '/admin-company/service-type', icon: faTable, iconColor: 'text-orange-500' },
        {
            id: 4,
    ...
    const getFilteredNav = (membershipType) => {
        switch (membershipType) {
            ...
            case 'Plus':
                return navName.slice(0, 6); // Show first 3 items for premium membership
            case 'Premium':
    ...
    return <DataContext.Provider value={{ filteredNav, breadcrumb, nameSidebar, companyName, company }}>{children}</DataContext.Provider>;
};
